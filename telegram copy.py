...
def handle_start(message):
    ...
    item1 = telebot.types.KeyboardButton("Obter Informações Climáticas - Cônego")
    item2 = telebot.types.KeyboardButton("Obter Informações Climáticas - Caledonia")
    markup.add(item1, item2)
    bot.send_message(chat_id, "Bem-vindo! Pressione um dos botões abaixo para obter dados climáticos.", reply_markup=markup)

@bot.message_handler(func=lambda message: message.text == "Obter Informações Climáticas - Cônego")
...
@bot.message_handler(func=lambda message: message.text == "Obter Informações Climáticas - Caledonia")
