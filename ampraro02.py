...
# URL do site
url = 'https://www.wunderground.com/weather/br/nova-friburgo/INOVAF29'
...
def extrair_informacoes(soup):
    ...
    # Temperatura Atual
    temp_div = soup.find('span', class_='wu-value wu-value-to')
    if temp_div:
        temp_f = float(temp_div.text.strip())
    ...
    if wind_div:
        ...
        # Remover caracteres indesejados e converter valores
...
print("Dados Climáticos da Estação Meteorológica - Amparo2")
